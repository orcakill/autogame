...
class TestOnmyojiService(TestCase):
    ...
    def test_foster_care(self):
        ...
        :return:；
        """
        TestOnmyojiService.test_project('3,4,5', '2', "式神寄养")
    ...
    def test_friends_fight(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('2,3,4,5', '5', "好友协战")
    ...
    def test_soul_arrange(self):
        ...
        TestOnmyojiService.test_project('5', '4', "御魂整理")
    ...
    def test_explore(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('1', '5', "探索")
