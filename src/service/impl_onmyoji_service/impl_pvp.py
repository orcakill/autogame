...
from src.model.models import GameProjectsRelation, GameAccount, GameProject, GameDevice, GameProjectLog
...
def pvp(game_task):
    ...
    logger.info("本轮斗技挑战，总用时{}秒，战斗总用时{}秒,平均战斗用时{}秒，挑战{}次，胜利{}次，失败{}次",
