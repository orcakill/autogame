...
class Onmyoji:
    ...
    reward_all_LQCG = r"奖励\一键完成\领取成功"
    ...
    soul_BQ_YHZXGH = r"探索\御魂\八岐大蛇\御魂自选更换"
    ...
    foster_JJK_SXDY = r"阴阳寮\式神寄养\结界卡\三星斗鱼"
    ...
    foster_ZCJJK_SXDY = r"阴阳寮\式神寄养\左侧结界卡\三星斗鱼"
...
class Switch:
    # 图像识别类型
    switch = ["切换", "缥缈之旅", "相伴相随", "桃映春馨", "两情相悦", "遥远之忆", "抢先体验服",
              "网易一缥缈之旅切换", "网易一相伴相随切换", "网易一桃映春馨切换", "网易一两情相悦切换","网易一遥远之忆切换",
              "缥缈之旅切换", "相伴相随切换", "桃映春馨切换", "两情相悦切换","遥远之忆切换",
              "网易一缥缈之旅", "网易一相伴相随", "网易一桃映春馨", "网易一两情相悦","网易一遥远之忆",
              "网易缥缈之旅", "网易相伴相随", "网易桃映春馨", "网易两情相悦","网易遥远之忆",
              "网易-缥缈之旅切换","网易-相伴相随切换", "网易-桃映春馨切换", "网易-两情相悦切换","网易-遥远之忆切换",
              "网易缥缈之旅切换", "网易相伴相随切换", "网易桃映春馨切换", "网易两情相悦切换", "网易遥远之忆切换",
              ]
